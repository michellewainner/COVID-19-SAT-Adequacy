...
[Tim Dwyer](https://www.linkedin.com/in/jtimdwyer/) (former DSI student and TA) put together [this style guide](https://git.generalassemb.ly/DSIR-0124/style-guide). Some recommendations are geared toward future projects (which will include modeling and span multiple notebooks), but generally these are great recommendations.
...
**Materials must be submitted on Friday, February 4.**
...
**Please fork the project, download or clone to your local machine, and submit a link in the [Google Classroom](https://classroom.google.com/u/1/c/NDU2MjM2MzIwNjAx) assignment.**

---

### Presentation Structure

**You must be ready to present your findings by the start of class on February 4.**
